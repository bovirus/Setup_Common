...
WelcomeLabel2=Aquest programa instal�lar� [name/ver] al vostre ordinador.%n%n�s molt recomanable que abans de continuar tanqueu tots els altres programes oberts, per tal d'evitar conflictes durant el proc�s d'instal�laci�.%n%nTingueu en compte que [name] requereix.NET 6.
...
ViewReadme=Veure el fitxer RadMe
AppIsRunning=s'està executant, tanqueu-lo per continuar amb la instal·lació.
DeleteConfigFiles=Voleu eliminar la configuració i excloure fitxers? Seleccioneu 'No' si teniu previst tornar a instal·lar.