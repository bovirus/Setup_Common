...
WelcomeLabel2=Este programa instalará [name/ver] en su sistema.%n%nSe recomienda cerrar todas las demás aplicaciones antes de continuar.%n%nTenga en cuenta que [name] requiere .NET 6.%n
...
ViewReadme=Abrir el archivo Léame
AppIsRunning=se está ejecutando, por favor ciérrelo para continuar con la instalación.
DeleteConfigFiles=¿Desea eliminar la configuración y excluir archivos? Seleccione 'No' si planea reinstalar.