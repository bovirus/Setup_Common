...
WelcomeLabel2=Este programa instalar� [name/ver] en su sistema.%n%nSe recomienda cerrar todas las dem�s aplicaciones antes de continuar.%n%nTenga en cuenta que [name] requiere .NET 6.%n
...
ViewReadme=Abrir el archivo L�ame
AppIsRunning=se est� ejecutando, por favor ci�rrelo para continuar con la instalaci�n.
DeleteConfigFiles=�Desea eliminar la configuraci�n y excluir archivos? Seleccione 'No' si planea reinstalar.