...
WelcomeLabel2=Ця програма встановить [name/ver] на ваш комп’ютер.%n%nРекомендується закрити всі інші програми перед продовженням.%n%nЗверніть увагу, що [name] вимагає .NET 6.
...
ViewReadme=Переглянути файл ReadMe
DeleteConfigFiles=запущено, будь ласка, закрийте його, щоб продовжити встановлення.
AppIsRunning=Ви хочете видалити налаштування і виключити файли? Виберіть "Ні", якщо ви плануєте перевстановити програму.